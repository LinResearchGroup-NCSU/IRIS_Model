...
def main():
    gamma_file_name = 'native_trainSetFiles_phi_pairwise_contact_well-9.5_9.5_0.7_10_gamma_filtered'  
    phi_file_name = 'phi_pairwise_contact_well_native_Rmodified_decoys_CPLEX_randomization_-9.5_9.5_0.7_10'
