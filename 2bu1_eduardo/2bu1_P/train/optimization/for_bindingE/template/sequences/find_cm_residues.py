...
def find_cm_residues(pdbfile, cutoff, random_position_file_protein, random_position_file_DNA):
 ...
 #   print(pdb_table)
    ...
    DNA_resID = pdb_table.loc[(pdb_table['resName'] == 'RA') |  (pdb_table['resName'] == 'RC') | (pdb_table['resName'] == 'RU') | (pdb_table['resName'] == 'RG')].drop_duplicates(subset=['resSeq']).resSeq.to_numpy()
    ...
    DNA_atom_indices = pdb.topology.select("resname =~ 'R[AUCG]'")
