        ...
        if CPLEXmodeling:
            if (res1 in res_list_tmonly):
                for res2 in get_neighbors_within_radius(neighbor_list, res1, r_max + 2.0):
                    ...
                    if (CPLEX_name == '72_ACAUUAGGUACGCCCAUGU_0'):                       
                        if (res2chain == 'A'):
...
evaluate_phis_over_training_set("proteins_list_forphi.txt", "phi1_list.txt", decoy_method='CPLEX_randomization', 
                                max_decoys=100000, tm_only=False, num_processors=1, CPLEXmodeling=True, CPLEX_name='72_ACAUUAGGUACGCCCAUGU_0')
